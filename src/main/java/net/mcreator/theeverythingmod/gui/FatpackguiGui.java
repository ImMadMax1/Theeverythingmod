...
package net.mcreator.theeverythingmod.gui;

import net.mcreator.theeverythingmod.TheEverythingModMod;

@TheEverythingModModElements.ModElement.Tag
public class FatpackguiGui extends TheEverythingModModElements.ModElement {

	public static HashMap guistate = new HashMap();

	private static ContainerType<GuiContainerMod> containerType = null;

	public FatpackguiGui(TheEverythingModModElements instance) {
		super(instance, 9);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("fatpackgui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				TheEverythingModMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));

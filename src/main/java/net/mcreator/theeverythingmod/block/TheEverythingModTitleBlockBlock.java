...
import net.mcreator.theeverythingmod.procedures.OnRightClickGiveAchievmentProcedure;
...
public class TheEverythingModTitleBlockBlock extends TheEverythingModModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PISTON).sound(SoundType.METAL).hardnessAndResistance(-1, 3600000).lightValue(4)

...
import net.mcreator.theeverythingmod.item.VioletoreGemItem;
...
public class VioletoreOreBlock extends TheEverythingModModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(19.5f, 22.351192022007744f).lightValue(0)

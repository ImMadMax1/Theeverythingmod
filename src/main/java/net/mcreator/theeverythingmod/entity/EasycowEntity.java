...
public class EasycowEntity extends TheEverythingModModElements.ModElement {
	public static EntityType entity = null;
	public EasycowEntity(TheEverythingModModElements instance) {
		super(instance, 53);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 1.4f)).build("easycow")
						.setRegistryName("easycow");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -11782623, -7707844, new Item.Properties().group(EverythingmodItemGroup.tab))
				.setRegistryName("easycow"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new CowModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("the_everything_mod:textures/cow.png");
			}
		});
	}
